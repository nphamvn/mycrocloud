...
public class WebApplicationAuthenticationSchemeRepository : IWebApplicationAuthenticationSchemeRepository
{
    private readonly string _connectionString;
    public WebApplicationAuthenticationSchemeRepository(GlobalSettings settings)
    {
