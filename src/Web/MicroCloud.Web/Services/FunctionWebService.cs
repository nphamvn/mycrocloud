...
using WebApplication.Domain.Functions;
...
public class FunctionWebService : BaseService, IFunctionWebService
{
    ...
    {
        var coreFunction = _mapper.Map<WebApplication.Domain.Functions.Function>(function);
    ...
    public class MapperProfile : Profile
    {
        ...
        {
            CreateMap<WebApplication.Domain.Functions.Function, FunctionSaveModel>().ReverseMap();
            CreateMap<WebApplication.Domain.Functions.Function, FunctionIndexItem>();
        }
    }
}
