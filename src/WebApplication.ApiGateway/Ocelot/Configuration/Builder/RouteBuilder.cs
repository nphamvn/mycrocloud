...
{
    using RouteResponseProvider = WebApplication.Domain.WebApplications.RouteResponseProvider;
    ...
    public class RouteBuilder
    {
        ...
        public RouteBuilder WithResponseProvider(RouteResponseProvider responseProvider) {
