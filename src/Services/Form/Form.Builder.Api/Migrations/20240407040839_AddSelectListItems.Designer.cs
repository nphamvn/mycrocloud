...
namespace Form.Builder.Api.Migrations
{
    ...
    [Migration("20240407040839_AddSelectListItems")]
    partial class AddSelectListItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Form.Builder.Api.Entities.FormSubmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Form.Builder.Api.Entities.FormSubmissionFieldValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("FormSubmissionFieldValues");
                });
            ...
            modelBuilder.Entity("Form.Builder.Api.Entities.FormSubmissionFieldValue", b =>
                {
                    ...
                    b.HasOne("Form.Builder.Api.Entities.FormSubmission", "FormSubmission")
                        .WithMany("Values")
