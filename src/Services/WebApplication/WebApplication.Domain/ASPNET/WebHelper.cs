...
namespace WebApplication.Domain.ASPNET
{
    /// <summary>
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContextAccessor.HttpContext.Items["IsPostBeingDoneRequestItem"] == null)
                    return false;

                return Convert.ToBoolean(_httpContextAccessor.HttpContext.Items["IsPostBeingDoneRequestItem"]);
            }

            set => _httpContextAccessor.HttpContext.Items["IsPostBeingDoneRequestItem"] = value;
        }
